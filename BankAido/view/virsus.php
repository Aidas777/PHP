<?php
    // include dirname(__DIR__ ,1) ."/indexx.php ";
?>
...
<?php
    ...
    // include dirname(__DIR__, 1).'/app/DataBase.php';
    // include dirname(__DIR__, 1).'/indexx.php';
?>
...
<body>
    ...
    <!-- <div class="nav-fixed"> -->
        <nav>
            ...
            <?php echo "<p class='saskSk'>Šiuo metu sąskaitų yra: " .count($bankas->saskaitosObj) ."</p>" ?>
            <?php endif; ?>
