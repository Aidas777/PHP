...
{{-- //// --}} 
                    <form method="POST" action="{{route('pet.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pet_bdate" class="form-control" value="{{old('pet_bdate')}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="pet_history" class="form-control" id="summernote">{{old('pet_history')}}</textarea>
