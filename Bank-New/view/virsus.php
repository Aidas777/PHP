...
<head>
    ...
    <title>Banko saskaitos OOP</title>
    ...
    <style>
        ...
        nav {
            ...
            border-radius: 20px;
            padding: 5px;
            box-shadow: 5px 5px 10px rgb(64, 76, 90);
            /* position: fixed; */
        }
        ...
        .containerH {
            ...
            border-radius: 10px;
            background-color: rgb(137, 165, 192);
            box-shadow: 5px 10px 10px dimgray;
        }
...
<body>
    ...
    <nav>
        ...
        <?php else : ?>
        <a class="btn-link conn" href="<?= URL ?>login">Prisijungti</a>
        <?php endif ?>


        <?php if (str_contains($_SERVER['REQUEST_URI'], 'list') && !isset($saskaitos['ReSNr'])) : ?>
